...
public class MiddleCubeMobilityEngage {

  public static Command get(DriveSubsystem driveSubsystem, ManipulatorSubystem manipulator) {

    final String PATH_NAME = MIDDLE_CUBE_MOBILITY_ENGAGE;
    PathPlannerTrajectory pathPlannerTrajectory =
        PathPlanner.loadPath(PATH_NAME, 1.5, MAX_ACCELERATION_METERS_PER_SECOND_SQUARED);
